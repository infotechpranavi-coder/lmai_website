...
export default function NotFound() {
    return (
        <div className="w-full h-screen flex flex-col items-center justify-center bg-background text-foreground text-center px-4">
            ...
            <h3 className="text-2xl font-bold uppercase tracking-widest mb-8">Event Not Found</h3>
            <p className="text-foreground/60 mb-8 max-w-md font-medium">
                We couldn't locate the specific event you are looking for. It may have been relocated or removed from our archives.
            </p>
